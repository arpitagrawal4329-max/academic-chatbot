...
# ==========================================
# 5. DYNAMIC CREDIT WELCOME SCREEN BANNER (1000055791.jpg)
# ==========================================
...
# ==========================================
# 6. APPLICATION NAVIGATION TABS (THE TABS BAR FROM 1000055791.jpg)
# ==========================================
...
# Shared function to render the interface logic for all tabs contextually
def render_chatbot_interface(mode_name, input_placeholder):
    ...
    # Inline File Uploader Block (Renders ABOVE text area box when active)
    ...
    if submit_btn:
        ...
        if not client_ready:
            ...
            # Formulate individual block validation structures per mode
            if mode_name == "Question Solver":
                system_scaffolding = (
                    "You are an expert high school tutor assistant operating strictly in Question Solver mode. "
                    "CRITICAL GUARDRAIL: You can ONLY solve specific questions, homework problems, numericals, or equations. If the user query is "
                    "asking you to write general topic summaries, complete chapter notes, or non-question concept outlines, you must reject it. "
                    "Respond verbatim with exactly: 'I can't process anything except questions.' Otherwise, provide a comprehensive "
                    "step-by-step breakdown validation solution.\n"
                )
            elif mode_name == "Topic Summary":
                system_scaffolding = (
                    "You are an expert high school tutor assistant operating strictly in Topic Summary mode. "
                    "CRITICAL GUARDRAIL: You can ONLY accept topic names or terms and provide structured revision summaries. If the user "
                    "is asking you to solve an explicit numerical equation, question worksheet calculation, or quiz problem, you must reject it. "
                ...
                system_scaffolding = (
                    "You are an expert high school tutor assistant operating strictly in Chapter Formula Sheet mode. "
            ...
            # Log title visual configurations
            ...
            if has_text:
                ...
                contents_payload.append("Process the action requirements on the attached parameters completely.")
...
# Connect the tabs dynamically to the UI function engines 
with tab1:
